 ...
 + "<div class='isso-form-wrapper'>"
  ...
  + "<div class='isso-auth-section'>"
    ...
    + "<p class='isso-post-action'>"
      + "<input type='submit' class='isso-postbox-submit' value='" + i18n('postbox-submit') + "' />"
    + "</p>"
    + "<p class='isso-post-action'>"
      + "<input type='button' name='preview' class='isso-postbox-preview' value='" + i18n('postbox-preview') + "' />"
    + "</p>"
    + "<p class='isso-post-action'>"
      + "<input type='button' name='edit' class='isso-postbox-edit' value='" + i18n('postbox-edit') + "' />"
    + "</p>"
  + "</div>"
